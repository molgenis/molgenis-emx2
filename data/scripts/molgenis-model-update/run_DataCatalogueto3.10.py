...
from update.update_3_10 import TransformDataCatalogue
...
session.download_zip(CATALOGUE_SCHEMA_NAME)
print(os.getcwd())
...
# transform data from SharedStaging
...
for cohort in COHORTS:
    ...
    transform_data = TransformDataCatalogue(cohort, 'cohort')
...
for data_source in DATA_SOURCES:
    ...
    transform_data = TransformDataCatalogue(data_source, 'data_source')
