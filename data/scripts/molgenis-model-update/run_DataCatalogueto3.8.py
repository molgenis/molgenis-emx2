...
from update.update_3_8 import Transform
from update.update_3_8 import TransformDataCatalogue
...
with Client(SERVER_URL) as client:
    ...
    client.signin(SERVER_USERNAME, SERVER_PASSWORD)

    # extract data from SharedStaging
    print('Extract data from ' + SHARED_STAGING_NAME)
    client.export(SHARED_STAGING_NAME)

    # extract data from catalogue schema
    print('Extract data from ' + CATALOGUE_SCHEMA_NAME)
    client.export(CATALOGUE_SCHEMA_NAME)
