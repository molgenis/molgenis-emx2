...
class TransformData:
    ...
    def variables(self):
        ...
        """
        df_target_vars = pd.read_csv(self.path + 'TargetVariables.csv')
        df_source_vars = pd.read_csv(self.path + 'SourceVariables.csv')
    ...
    def variable_values(self):
        ...
        """
        df_target_vars_values = pd.read_csv(self.path + 'TargetVariableValues.csv')
        df_source_vars_values = pd.read_csv(self.path + 'SourceVariableValues.csv')
    ...
    def repeated_variables(self):
        ...
        """
        df_repeated_target_vars = pd.read_csv(self.path + 'TargetVariables.csv')
        df_repeated_source_vars = pd.read_csv(self.path + 'SourceVariables.csv')
    ...
    def dataset_mappings(self):
        ...
        """
        df_table_mappings = pd.read_csv(self.path + 'TableMappings.csv')
    ...
    def variable_mappings(self):
        """Rename columns TableMappings
        """
        df_variable_mappings = pd.read_csv(self.path + 'TableMappings.csv')
