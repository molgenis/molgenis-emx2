...
2. A catalogue schema is made with template (DATA_CATALOGUE), which also instantiates the CatalogueOntologies schema and imports the ontology data
...
8. Other schemas that have no Profiles table are moved by hand as is. Check whether this is appropriate for each schema.
