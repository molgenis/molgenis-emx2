...
- Website: [https://github.com/rsc-ontology/rsc-cmo](https://github.com/rsc-ontology/rsc-cmo)
- License: [CC-BY-4.0](https://github.com/rsc-ontology/rsc-cmo/blob/master/LICENSE)

### Dublin Core (DC)

- Website: [https://www.dublincore.org/](https://www.dublincore.org/)
- License: [CC-BY-4.0](https://www.dublincore.org/about/copyright/)

### Data Use Ontology (DUO)

- Website: [https://github.com/EBISPOT/DUO](https://github.com/EBISPOT/DUO)
- License: [CC-BY-4.0](https://github.com/EBISPOT/DUO/blob/master/LICENSE.md)

### The data analysis and management ontology (EDAM)

- Website: [https://github.com/edamontology/edamontology](https://github.com/edamontology/edamontology)
- License: [CC-BY-4.0](https://github.com/edamontology/edamontology/blob/main/LICENSE)
...
- License: [CC0](https://www.ebi.ac.uk/licencing/)

 Malone J, Holloway E, Adamusiak T, Kapushesky M, Zheng J, Kolesnikov N, Zhukova, A, Brazma A, Parkinson H. Modeling sample variables with an Experimental Factor Ontology. Bioinformatics. 2010 Apr 15;26(8):1112-8. Epub 2010 Mar 3. PubMed PMID: 20200009; PubMed Central PMCID: PMC2853691. [http://bioinformatics.oxfordjournals.org/content/26/8/1112.full](http://bioinformatics.oxfordjournals.org/content/26/8/1112.full)

### FAIR Genomes Semantic Model (FG)

- Website: [https://github.com/fairgenomes/fairgenomes-semantic-model](https://github.com/fairgenomes/fairgenomes-semantic-model)
- License: [CC-BY-4.0](https://github.com/fairgenomes/fairgenomes-semantic-model/blob/main/LICENSE)

van der Velde, K.J., Singh, G., Kaliyaperumal, R. et al. FAIR Genomes metadata schema promoting Next Generation Sequencing data reuse in Dutch healthcare and research. Sci Data 9, 169 (2022). [https://doi.org/10.1038/s41597-022-01265-x](https://doi.org/10.1038/s41597-022-01265-x)

### Genomic Epidemiology Application Ontology (GENEPIO)

- Website: [https://genepio.org/](https://genepio.org/)
- License: [CC-BY-3.0](https://github.com/GenEpiO/genepio/blob/master/LICENSE)

### Genotype Ontology (GENO)

- Website: [https://github.com/monarch-initiative/GENO-ontology/](https://github.com/monarch-initiative/GENO-ontology/)
- License: CC-BY-4.0

### Gender, Sex, and Sexual Orientation Ontology (GSSO)

- Website: [https://gsso.research.cchmc.org/#!/](https://gsso.research.cchmc.org/#!/)
...
- Website: [https://github.com/EBISPOT/hancestro](https://github.com/EBISPOT/hancestro)
- License: [CC-BY-4.0](https://github.com/EBISPOT/hancestro/blob/main/LICENSE)

_Joannella Morales, Danielle Welter, Emily H. Bowler, Maria Cerezo, Laura W. Harris, Aoife C. McMahon, Peggy Hall, Heather A. Junkins, Annalisa Milano, Emma Hastings, Cinzia Malangone, Annalisa Buniello, Tony Burdett, Paul Flicek, Helen Parkinson, Fiona Cunningham, Lucia A. Hindorff and Jacqueline A. L. MacArthur_. [**A standardized framework for representation of ancestry data in genomics studies, with application to the NHGRI-EBI GWAS Catalog**](https://genomebiology.biomedcentral.com/articles/10.1186/s13059-018-1396-2). Genome Biology, 2018, 19:21

### HUGO Gene Nomenclature (HGNC)

- Website: [https://www.genenames.org/](https://www.genenames.org/)
- License: [CC0](https://www.genenames.org/about/license/)

Genenames.org: the HGNC resources in 2023, Ruth L Seal, Bryony Braschi, Kristian Gray, Tamsin E M Jones, Susan Tweedie, Liora Haim-Vilmovsky, Elspeth A Bruford, Nucleic Acids Research (Database issue), [NAR](https://academic.oup.com/nar/advance-article/doi/10.1093/nar/gkac888/6761747) | [EuropePMC](http://europepmc.org/article/MED/36243972) | [PubMed](https://pubmed.ncbi.nlm.nih.gov/36243972/)

### Health Level Seven Reference Implementation Model, Version 3 (HL7)

- Website: [http://www.hl7.org/](http://www.hl7.org/)
- License: [https://hpo.jax.org/license](https://hpo.jax.org/license)

### Human Phenotype Ontology (HPO)

Created by the Human Phenotype Ontology Consortium
...
### International Classifcation of Diseases Ontology (ICDO)

- Website: [https://github.com/icdo/ICDO](https://github.com/icdo/ICDO)
- License: CC-BY-4.0

### International Classification of Functioning, Disability and Health (ICF)

- Website: [https://www.who.int/classifications/international-classification-of-functioning-disability-and-health](https://www.who.int/classifications/international-classification-of-functioning-disability-and-health)
- License: [CC-BY-ND-3.0](https://icd.who.int/en/)

### Informed Consent Ontology (ICO)

- Website: [https://github.com/ICO-ontology/ICO](https://github.com/ICO-ontology/ICO)
- License: [CC-BY-4.0](https://github.com/ICO-ontology/ICO/blob/master/LICENSE.txt)

### Metabolomics Standards Initiative Ontology (MSIO)

- Website: [https://github.com/MSI-Metabolomics-Standards-Initiative/MSIO](https://github.com/MSI-Metabolomics-Standards-Initiative/MSIO)
- License:

### National Cancer Institute Thesaurus (NCIT)

- Website: [https://evsexplore.semantics.cancer.gov/evsexplore/welcome](https://evsexplore.semantics.cancer.gov/evsexplore/welcome)
- License: [https://www.cancer.gov/policies/copyright-reuse](https://www.cancer.gov/policies/copyright-reuse)

### Next Generation Biobanking Ontology (NGBO)

- Website: [https://github.com/Dalalghamdi/NGBO](https://github.com/Dalalghamdi/NGBO)
- License: [CC-BY-4.0](https://github.com/Dalalghamdi/NGBO/blob/master/LICENSE)

### Ontology for Biomedical Investigations (OBI)

- Website: [https://bioportal.bioontology.org/ontologies/OBI](https://bioportal.bioontology.org/ontologies/OBI)
- License: CC-BY-4.0

### Ontology for Biobanking (OBIB)

- Website: [https://github.com/biobanking/biobanking/](https://github.com/biobanking/biobanking/)
- License: [CC-BY-4.0](https://github.com/biobanking/biobanking/blob/master/LICENSE)

### Ontology for General Medical Science (OGMS)

- Website: [https://github.com/OGMS/ogms](https://github.com/OGMS/ogms)
- License: CC-BY-4.0

### Ontology for Genetic Susceptibility Factor (OGSF)

- Website: [https://bioportal.bioontology.org/ontologies/OGSF](https://bioportal.bioontology.org/ontologies/OGSF)
- License: [BSD-3](https://opensource.org/license/BSD-3-Clause)

### Ontologized MIABIAS

- Website: [https://github.com/OMIABIS/omiabis-dev](https://github.com/OMIABIS/omiabis-dev)
- License: CC-BY-3.0

### Ontology for MicroRNA Target (OMIT)

- Website: [https://github.com/OmniSearch/omit](https://github.com/OmniSearch/omit)
- License: CC-BY-3.0

### Ontology of Precision Medicine and Investigation (OPMI)

- Website: [https://github.com/OPMI/opmi](https://github.com/OPMI/opmi)
- License: [CC-BY-4.0](https://github.com/OPMI/opmi/blob/master/LICENSE)
...
- Website: [https://sciences.orphadata.com/](https://sciences.orphadata.com/)
- License: CC-BY-4.0

Orphadata Science: Free access data from Orphanet. © INSERM 1999. Available on [http://sciences.orphadata.com/](http://sciences.orphadata.com/). Data version [Date of data version].
...
- Website: [https://github.com/scdodev/scdo-ontology](https://github.com/scdodev/scdo-ontology)
- License: CC-BY-4.0
