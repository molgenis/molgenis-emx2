...
import type {Resp, Schema} from "../../../../../../tailwind-components/types/types"
...
useHead({ title: `${routeShaclSet} - SHACL - RDF - ${routeSchema}  - Molgenis` });
...
<template>
  <Container>
    <PageHeader
        :title="`${routeShaclSet} for ${routeSchema}`"
        align="left"
    >
      <template #prefix>
