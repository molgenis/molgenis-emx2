...
export default {
  ...
  methods: {
    loadSchema() {
      ...
      request(
        "graphql",
        "{_schema{id,label,canManage,tables{id,label,tableType,description,canView,canInsert,canUpdate,canDelete,columns{id,label,columnType,key,refTableId,required,description}}}}"
      )
        .then((data) => {
