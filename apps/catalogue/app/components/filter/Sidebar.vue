...
import FilterContainer from "./Container.vue";
import FilterSearch from "../../../../tailwind-components/app/components/filter/Search.vue";
import FilterOntology from "./Ontology.vue";
import FilterList from "./List.vue";
  ...
  >
    ...
    <template v-if="filters">
      <FilterContainer
        ...
        :conditions="
          (filter as IOntologyFilter | IRefArrayFilter).conditions
            ? (filter as IOntologyFilter | IRefArrayFilter).conditions
            : []
        "
        @update:conditions="
          (value: IFilterCondition[]) => {
            (filter as IOntologyFilter).conditions = value;
      ...
      >
        ...
        <FilterList
          ...
          @update:model-value="
            (value: IFilterCondition[]) => {
              (filter as IRefArrayFilter).conditions = value;
              handleFilerUpdate(filter);
            }
          "
        />
