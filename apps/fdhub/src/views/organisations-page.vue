  ...
  <Page>
    ...
    <PageSection aria-labelledby="welcome-title" :verticalPadding="2">
      ...
      <p>
        ...
        <a href="https://ror.org/">ROR</a> registry. This allows you to select
        organisations and save the metadata into the
        <strong>Organisations</strong> ontology table.
      </p>
      <form class="page-form" id="organisationSearch">
        <label for="orgsearch" class="input-label">
          ...
          <span class="input-description"
            >E.g., London, King's College London, etc.</span
          >
        </label>
        ...
        <fieldset class="org-details">
          ...
          <div>
            <label for="ror-name-official">
              ...
              <span
                >Enter the official name specified by the relevant project</span
              >
            </label>
            <input
