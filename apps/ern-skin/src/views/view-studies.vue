<template>
  <Page id="page-documents">
    ...
    >
      ...
      The transparency portal, as defined by the CNIL, allows you to be informed
      of research projects that utilize information gathered within the
      framework of ERRAS: the European Registry for RAre Skin diseases. <br />
      These projects are essential to foster research on rare skin diseases, to
      improve the lives of patients, the knowledge and the treatment of their
      diseases. <br />
      Each project is summarized in accordance with the General Data Protection
      Regulation (GDPR) as defined in Articles 12 and following:<br />
      <blockquote id="quote-nav">
      ...
      Each summary allows you to understand the objectives pursued by the
      research, the population involved, and the data used.
