...
export default {
  ...
  data: function () {
    return {
      ...
      template: null,
      templates: [null, "PET_STORE", "FAIR_DATA_HUB", "DATA_CATALOGUE", "DATA_CATALOGUE_COHORT_STAGING","DATA_CATALOGUE_NETWORK_STAGING","DATA_CATALOGUE3", "DATA_CATALOGUE_COHORT_STAGING3","DATA_CATALOGUE_NETWORK_STAGING3"],
