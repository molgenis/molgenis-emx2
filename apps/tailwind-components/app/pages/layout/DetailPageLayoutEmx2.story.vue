...
const config = computed<IRecordViewConfig>(() => ({
...
<template>
  <div class="p-4">
    <h1 class="text-heading-xl mb-4">Emx2RecordView with DetailPageLayout</h1>
    <p class="text-body-base mb-4">
      Full detail page pattern: Emx2RecordView fetches data and renders
      RecordView with auto-generated SideNav from SECTION columns.
    </p>
