...
const COLOR_MAPPING: Record<ButtonType, string> = {
  ...
  text: "group px-2 flex items-center text-button-text hover:bg-hover hover:text-link-hover cursor-pointer disabled:cursor-not-allowed disabled:text-button-text-disabled disabled:hover:bg-transparent border-none h-auto",
  outline:
