  ...
  theme: {
    ...
    extend: {
      ...
      backgroundColor: ({ theme }) => ({
        ...
        "button-secondary-hover": "var(--background-color-button-secondary-hover)",
        "button-tertiary": "var(--background-color-button-tertiary)",
        "button-tertiary-hover": "var(--background-color-button-tertiary-hover)",
        ...
        "button-filter-well": "var(--background-color-button-filter-well)",
        ...
        "search-results-view-tabs": "var(--background-color-search-results-view-tabs)",
        "search-filter-group-toggle": "var(--background-color-search-filter-group-toggle)",
        "app-wrapper": "var(--background-color-app-wrapper)",
        "pagination": "var(--background-color-pagination)",
        "pagination-hover": "var(--background-color-pagination)",
      ...
      textColor: ({ theme }) => ({
        ...
        "button-tertiary": "var(--text-color-button-tetiary)",
        ...
        "button-filter-well": "var(--text-color-button-filter-well)",
      ...
      borderColor: ({ theme }) => ({
        ...
        "button-tertiary": "var(--border-color-button-tetiary)",
