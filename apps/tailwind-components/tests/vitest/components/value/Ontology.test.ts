...
// varies by anything ValueOntology exposes, so there is exactly one value
// to pin, everywhere a tooltip can render.
describe("value/Ontology.vue tooltip hover colour", () => {
  ...
  it("uses hoverColor white for the single-item branch", () => {
    const wrapper = mount(ValueOntology, { props: { value: singleItem } });
  ...
  it("uses hoverColor white for the flat-list branch", () => {
    const wrapper = mount(ValueOntology, { props: { value: flatList } });
...
describe("value/Ontology.vue renders every root", () => {
...
describe("value/Ontology.vue name affordance", () => {
...
describe("value/Ontology.vue root markup", () => {
...
describe("value/Ontology.vue nested row spacing", () => {
...
describe("value/Ontology.vue root-level item paging", () => {
...
describe("value/Ontology.vue two levels page independently", () => {
