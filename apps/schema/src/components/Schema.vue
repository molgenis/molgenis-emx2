...
export default {
  ...
  methods: {
    ...
    loadSchema() {
      ...
      request(
        "graphql",
        "{_schema{name,tables{name,inherit,description,columns{name,columnType,key,refTable,mappedBy,cascadeDelete,nullable,description,rdfTemplate}}}}"
      )
        .then(data => {
