  ...
  <div id="app" class="d-flex" >
    ...
    <div id="page-content-wrapper" class="m-3 container-fluid">
      ...
      <demo-item id="page-header" label="Page Header">
          ...
          <page-header title="My title" subTitle="and subtitle" logoUrl="https://avatars.githubusercontent.com/u/1688158?s=200&v=4"></page-header>
      </demo-item>

      <demo-item id="links-list" label="Links list">
        <label class="font-italic">basic list of links</label>
        <links-list :items="[{label: 'Molgenis', href: 'https://molgenis.org'}, {label: 'Google', href: 'https://google.com'}]"></links-list>
      </demo-item>
