      ...
      <div>
        <form class="form-inline flex-nowrap">
          ...
          <div>
            ...
            <InputString :id="'menu-label' + idx" v-model="element.label" :defaultValue="element.label"/>
          </div>
          <div>
            <label v-if="idx == 0">href</label>
            <InputString :id="'menu-href' + idx" v-model="element.href" :defaultValue="element.href"/>
          </div>
          <div>
        ...
        <MenuManager v-if="element.submenu" :items="element.submenu" class="ml-4"/>
      </div>
    </template>
  </Draggable>
</template>
