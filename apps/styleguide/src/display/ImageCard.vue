...
<template>
    <div class="row">
     <div class="col-3">
      <image-card description="All your bases are belong to us" linkUrl="https://en.wikipedia.org/wiki/All_your_base_are_belong_to_us" >
        <template v-slot:image>
            <image-display url="https://upload.wikimedia.org/wikipedia/en/thumb/0/03/Aybabtu.png/220px-Aybabtu.png"></image-display>
        </template>
      </image-card>
    </div>
    </div>
