...
- Then you can simply run 'pnpm dev' inside your app folder, e.g. cd to 'helloworld' and run 'pnpm dev'

We also have component library in molgenis-components, which can be linked into your app

- When making changes to molgenis-components you have to run 'pnpm build' to get your changes available in your app also
