...
test('Catalogue test number 1: Athlete network manager', async ({ page, goto, contextOptions}) => {
  
  await goto(`${process.env.E2E_BASE_URL || 'https://emx2.dev.molgenis.org'}/catalogue-demo/ssr-catalogue/`, { waitUntil: 'hydration',  });
