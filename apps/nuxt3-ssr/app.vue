<template>
  <div
    class="min-h-screen bg-base-gradient relative overflow-x-hidden after:bg-app-wrapper after:w-full after:h-[166px] after:top-0 after:absolute after:opacity-20 after:z-20 xl:after:hidden">
    ...
    <div class="z-30 relative">
      ...
      <slot name="footer">
        ...
        <div class="mb-0 text-center lg:mb-5 text-body-lg"> Please cite <a
