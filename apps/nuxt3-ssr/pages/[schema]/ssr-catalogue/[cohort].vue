  ...
  <LayoutsDetailPage>
    ...
    <template #main>
      <ContentBlocks>
        ...
        <ContentBlockVariables id="Variables" title="Variables & Topics"
        ...
        <ContentBlockData id="AvailableData" title="Available Data & Samples"
          description="Explantation about variables and the functionality seen here. similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga." />
        <ContentBlockSubpopulations id="Subpopulations" title="Subpopulations"
        ...
        <ContentBlockCollectionEvents id="CollectionEvents" title="Collection Events"
        ...
        <ContentBlockNetwork id="Networks" title="Networks"
        ...
        <ContentBlockPartners id="Partners" title="Partners"
