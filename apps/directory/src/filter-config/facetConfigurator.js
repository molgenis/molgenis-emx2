import { customFilterOptions, genericFilterOptions, ontologyFilterOptions } from './filterOptions'
    ...
    filterFacets.push(
      {
        ...
        filterValueAttribute: facet.filterValueAttribute || 'id', /** specify a column name if you want a different column for the value */
        filterLabelAttribute: facet.filterLabelAttribute || 'name', /** specify if you want to use another column as the label for the filter option, instead of name */
        ...
        adaptive: facet.adaptive || false, /** if the filters options should react on search results */
