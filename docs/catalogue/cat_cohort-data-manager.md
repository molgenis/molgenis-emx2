...
- <b>Your own database</b>: use this to upload the [templates](https://data-catalogue.molgeniscloud.org/apps/docs/#/catalogue/cat_cohort-data-manager?id=define-source-variable-metadata-data-dictionary) once you have filled them out.
