...
| collection event | Refer to the name of a collection event | The collection event needs to be predefined in the Collection events table in the cohort or data source staging area; e.g. y1 or y2 |
...
| collection event | Refer to the name of a collection event | The collection event needs to be predefined in the table Collection Events in the cohort or data source staging area; e.g. y1 or y2 |
| since version | Version of the data model when this variable was introduced | e.g. 1.0.0 or 2.1 |
| until version | Version of the data model when this variable was deleted | e.g. 2.0.0 or 2.1 |
