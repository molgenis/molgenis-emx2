...
| 1.9=> 1.10 | feat: add Database.populationSize(captured,active), RWEresources.approvalForPublication, Dispensing 
subterms. Just upload molgenis.csv to update. |
| 1.10=> 1.11 | feat: split VariableValues into SourceVariableValues and TargetVariableValues, Variables into SourceVariables and TargetVariables, RepeatedVariables into RepeatedSourceVariables and RepeatedTargetVariables |
