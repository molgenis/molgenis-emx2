...
public class Constants {
  ...
  // 1–63 characters long starting with a letter or undersore, may contain letters, digits, spaces, hyphens,
  ...
  // spaces)
  public static final String SCHEMA_NAME_REGEX = "^(?!.* _|.*_ )[a-zA-Z_][-a-zA-Z0-9 _]{0,62}$";
