...
public enum ColumnType {
  ...
  AUTO_ID(STRING),
  ONTOLOGY(REF, MATCH_ANY_INCLUDING_CHILDREN, MATCH_ANY_INCLUDING_PARENTS),
  ONTOLOGY_ARRAY(REF_ARRAY, MATCH_ANY_INCLUDING_CHILDREN, MATCH_ANY_INCLUDING_PARENTS),
