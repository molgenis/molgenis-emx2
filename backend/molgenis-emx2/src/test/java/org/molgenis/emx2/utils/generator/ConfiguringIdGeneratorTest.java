...
class ConfiguringIdGeneratorTest {
  ...
  void givenLetters_thenGenerateUsingLetters() {
    ConfiguringIdGenerator generator =
        new ConfiguringIdGenerator(
            AutoIdFormat.Format.LETTERS, 5, createStaticSupplier(0, 51, 13, 34, 20));
  ...
  void givenNumbers_thenGenerateUsingNumbers() {
    ConfiguringIdGenerator generator =
        new ConfiguringIdGenerator(
            AutoIdFormat.Format.NUMBERS, 5, createStaticSupplier(0, 3, 8, 2, 9));
  ...
  void givenMixed_thenGenerateUsingNumbersAndLetters() {
    ConfiguringIdGenerator generator =
        new ConfiguringIdGenerator(
            AutoIdFormat.Format.MIXED, 9, createStaticSupplier(0, 53, 55, 51, 13, 60, 34, 20, 58));
  ...
  void givenLength_thenGenerateSetLength() {
    ConfiguringIdGenerator generator =
        new ConfiguringIdGenerator(AutoIdFormat.Format.LETTERS, 1, createStaticSupplier(0));
  ...
  void fromConfigurationFuzzTest() {
    ...
    ConfiguringIdGenerator generator =
        ConfiguringIdGenerator.fromAutoIdConfig(new AutoIdFormat(AutoIdFormat.Format.NUMBERS, 5));
