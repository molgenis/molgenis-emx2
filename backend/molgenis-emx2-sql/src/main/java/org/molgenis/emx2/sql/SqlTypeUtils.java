...
import static org.molgenis.emx2.ColumnType.VARIANT;
import static org.molgenis.emx2.ColumnType.VARIANT_ARRAY;
...
public class SqlTypeUtils extends TypeUtils {
  ...
  private static void checkRequired(Column c, Row row, Map<String, Object> values) {
    if (!row.isDraft()
        ...
        && !VARIANT.equals(c.getColumnType())
        && !VARIANT_ARRAY.equals(c.getColumnType())) {
