...
public class RestOverGraphql {
  ...
  public static String getTableAsJson(
    ...
    String query = String.format("{%s{...%sAllFields}}", tableId, tableId);
    return graphql.queryAsString(query, variables);
  }

  public static String getTableAsTurtle(GraphqlExecutor graphql, String tableId, String schemaUrl) {
    return getTableAsTurtle(graphql, tableId, schemaUrl, Map.of());
  }

  public static String getTableAsTurtle(
      GraphqlExecutor graphql, String tableId, String schemaUrl, Map<String, Object> variables) {
    try {
      String query = String.format("{%s{...%sAllFields}}", tableId, tableId);
