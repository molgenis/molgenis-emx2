      ...
      ExecutionResult executionResult =
          grapql.execute(
              "{Individuals"
                  ...
                  + "{"
                  + "id,"
                  + "sex{name,codesystem,code,ontologyTermURI},"
                  + AGE_AGEGROUP
                  + NAME_CODESYSTEM_CODE
                  + AGE_AGE_ISO8601DURATION
                  + ","
                  + "diseaseCausalGenes{name,codesystem,code,ontologyTermURI},"
                  + "ethnicity{name,codesystem,code,ontologyTermURI},"
                  + "geographicOrigin{name,codesystem,code,ontologyTermURI},"
                  + "phenotypicFeatures{"
                  + "   featureType{name,codesystem,code,ontologyTermURI},"
                  + "   modifiers{name,codesystem,code,ontologyTermURI},"
                  + "   severity{name,codesystem,code,ontologyTermURI}},"
                  + "diseases{"
                  + DISEASECODE
                  + NAME_CODESYSTEM_CODE
                  + AGEOFONSET_AGEGROUP
                  ...
                  + "measures{"
                  + "   assayCode{name,codesystem,code,ontologyTermURI},"
                  + "   date,"
                  + "   measurementVariable,"
                  + "   measurementValue_value,"
                  + "   measurementValue_units{name,codesystem,code,ontologyTermURI},"
