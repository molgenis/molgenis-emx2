...
public class TestLoaders {
    ...
    public static final String DATA_CATALOGUE_FEDERATED_DATA_ACCESS =
        "FederatedDataAccess";
    ...
    public void test01FAIRDataHubLoader() {
        ...
        DataModels.Profile.FAIR_DATA_HUB.getImportTask(
            fairDataHubSchema,
            true
        ).run();
        assertEquals(71, fairDataHubSchema.getTableNames().size());
        String[] semantics = fairDataHubSchema
            .getTable("BiospecimenType")
            .getMetadata()
            .getSemantics();
        assertEquals(
            "http://purl.obolibrary.org/obo/NCIT_C70699",
            semantics[0]
        );
        assertEquals(
    ...
    void test06DataCatalogueLoader() throws Exception {
        ...
        DataModels.Profile.DATA_CATALOGUE.getImportTask(
            dataCatalogue,
            true
        ).run();
    ...
    public void test07DataCatalogueCohortStagingLoader() {
        ...
        DataModels.Profile.DATA_CATALOGUE_COHORT_STAGING.getImportTask(
            cohortStaging,
            true
        ).run();
    ...
    public void test08DataCatalogueNetworkStagingLoader() {
        ...
        DataModels.Profile.DATA_CATALOGUE_NETWORK_STAGING.getImportTask(
            networkStaging,
            true
        ).run();
    ...
    public void test09DirectoryLoader() {
        ...
        DataModels.Regular.BIOBANK_DIRECTORY.getImportTask(
            directory,
            true
        ).run();
    ...
    void test11JRCCDELoader() {
        ...
        DataModels.Profile.JRC_COMMON_DATA_ELEMENTS.getImportTask(
            JRCCDESchema,
            true
        ).run();
    ...
    void test12FAIRGenomesLoader() {
        ...
        DataModels.Profile.FAIR_GENOMES.getImportTask(
            FAIRGenomesSchema,
            true
        ).run();
    ...
    void test13ProjectManagerLoader() {
        ...
        DataModels.Regular.PROJECTMANAGER.getImportTask(
    ...
    void test15DirectoryStagingLoader() {
        ...
        DataModels.Regular.BIOBANK_DIRECTORY_STAGING.getImportTask(
            directoryStaging,
            false
        ).run();
    ...
    public void patientRegistryDemoTestLoader() {
        ...
        DataModels.Regular.PATIENT_REGISTRY_DEMO.getImportTask(
            schema,
            true
        ).run();
    ...
    public void test19DataCatalogueFederatedDataAccessLoader() {
        ...
        DataModels.Profile.DATA_CATALOGUE_FEDERATED_DATA_ACCESS.getImportTask(
            schema,
            true
        ).run();
