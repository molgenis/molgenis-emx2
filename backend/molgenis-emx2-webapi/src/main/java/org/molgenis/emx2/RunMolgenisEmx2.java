...
public class RunMolgenisEmx2 {
  ...
  public static final boolean RELOAD_ONTOLOGIES =
      (Boolean) EnvironmentProperty.getParameter(Constants.MOLGENIS_RELOAD_ONTOLOGIES, false, BOOL);
  ...
  public static void main(String[] args) {
    ...
    database.tx(
        db -> {
          ...
          if (RELOAD_ONTOLOGIES && db.getSchema(CATALOGUE_ONTOLOGIES) != null) {
