...
public class CatalogueSiteMapTest {
  ...
  void buildSiteMapForSchemaWithVariables() {
    ...
    <urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9" >
      ...
      <url>
        <loc>https://my/base/url/all/variables/Var%20name-lifetime-core-lifetime?keys=%7B%22name%22%3A%22Var+name%22%2C%22resource%22%3A%7B%22id%22%3A%22lifetime%22%7D%2C%22table%22%3A%7B%22name%22%3A%22core%22%2C%22resource%22%3A%7B%22id%22%3A%22lifetime%22%7D%7D%7D</loc>
      </url>
    </urlset>""";
    assertEquals(expected, catalogueSiteMap.buildSiteMap());
  }
