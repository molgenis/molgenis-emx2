...
public class WebApiSmokeTests {
  ...
  public void testCsvApi_csvTableMetadataUpdate() throws IOException {
    ...
    String header =
        "tableName,tableExtends,tableType,columnName,columnType,key,required,refSchema,refTable,refLink,refBack,refLabel,validation,semantics,label,description\r\n";
