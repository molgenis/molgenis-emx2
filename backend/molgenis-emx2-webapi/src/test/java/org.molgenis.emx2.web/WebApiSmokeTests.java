...
public class WebApiSmokeTests {
  ...
  public void testCsvApi_csvTableMetadataUpdate() throws IOException {
    ...
    String header =
        "tableName,tableExtends,tableType,columnName,columnType,key,required,refSchema,refTable,refLink,refBack,refLabel,validation,visible,computed,semantics,profiles,label,description\r\n";
