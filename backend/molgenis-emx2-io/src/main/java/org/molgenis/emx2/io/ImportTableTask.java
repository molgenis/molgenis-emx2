...
public class ImportTableTask extends Task {
  ...
  public ImportTableTask(TableStore tableStore, Table table, boolean strict) {
  ...
  public void run() {
    ...
    tableStore.processTable(table.getName(), new ValidatePkeyProcessor(table.getMetadata(), this));
    ...
    tableStore.processTable(table.getName(), new ImportRowProcesssor(table, this));
