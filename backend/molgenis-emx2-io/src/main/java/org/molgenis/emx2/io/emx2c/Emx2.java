// package org.molgenis.emx2.io.emx2c;
//
...
//    // deterministi//    List<String> tableNames = new ArrayList<>();c order (TODO make user
// define order)
...
//    if (column.getValidation() != null) def.add(Emx2PropertyList.VALIDATE,
