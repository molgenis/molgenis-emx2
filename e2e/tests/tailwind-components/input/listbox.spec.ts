...
test.describe("Listbox component", {
  ...
  test(
    "options list is properly linked to the listbox",
    async ({ page }) => {
      await page.goto("/apps/tailwind-components/#/input/Listbox.story");
      const combobox = await page.getByRole("combobox");
  ...
  test(
    "aria expand properties correctly update when opened",
    async({ page }) => {
      await page.goto("/apps/tailwind-components/#/input/Listbox.story");
      const combobox = await page.getByRole("combobox");
  ...
  test(
    "placeholder is always the first element in the list",
    async ({ page }) => {
      await page.goto("/apps/tailwind-components/#/input/Listbox.story");
      const combobox = await page.getByRole("combobox");
      await combobox.click();
  ...
  test(
    "list items have the proper attributes",
    async ({ page }) => {
      await page.goto("/apps/tailwind-components/#/input/Listbox.story");
      const combobox = await page.getByRole("combobox");
      await combobox.click();
