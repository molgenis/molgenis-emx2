...
| 14 | Open 'Harmonizations' tab | Harmonizations tab should show only variables ('testVarRepeats' and 'testVarNoRepeats') and cohorts part of the network; Show correct statuses for harmonization (testCohort1: has info; testCohort2: no info; testCohort3: has info; testCohort4: no info)| | 
