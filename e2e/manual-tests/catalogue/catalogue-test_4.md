...
| 11 | In "Harmonisation status per source", hover over 'about statuses' | Pop up should show 'completed: source was able to fully map to the harmonised variables'; 'partially: source was able to partially map to the harmonised variable'; 'No data: no harmonisation data is available'. | | |
