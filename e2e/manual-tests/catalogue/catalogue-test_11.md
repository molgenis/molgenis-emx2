...
| ---- | ------ | --------------- | ---------------- | --------------- |
| 0 | Navigate to the [all catalogue contents screen](https://data-catalogue-acc.molgeniscloud.org/testCatalogue/catalogue/all) | End up on the 'browse all catalogue contents'-screen | | |
| 1 | Click on `VARIABLES` in the menu | End up at [the variable explorer](https://data-catalogue-acc.molgeniscloud.org/testCatalogue/catalogue/all/variables) | | |
| 2 | Go back using the browser back button | End up at [the all catalogue contents screen](https://data-catalogue-acc.molgeniscloud.org/testCatalogue/catalogue/all) | | |
| 3 | Click on the word `VARIABLES` underneath the logo | End up at [the variable explorer](https://data-catalogue-acc.molgeniscloud.org/testCatalogue/catalogue/all/variables) | | |
| 4 | Go back by clicking the Molgenis logo in the top left | End up at [the all catalogue contents screen](https://data-catalogue-acc.molgeniscloud.org/testCatalogue/catalogue/all) | | |
| 5 | Click on the variables CTA-button | End up at [the variable explorer](https://data-catalogue-acc.molgeniscloud.org/testCatalogue/catalogue/all/variables) | | |
| 6 | Check the breadcrumb | It should be `ALL > VARIABLES` | | |
| 7 | Go back by clicking the `ALL` breadcrumb | End up at [the all catalogue contents screen](https://data-catalogue-acc.molgeniscloud.org/testCatalogue/catalogue/all) | | |
...
| | | | | |
| 17 | Click on the `NETWORKS` CTA-button | End up at [the networks screen](https://data-catalogue-acc.molgeniscloud.org/testCatalogue/catalogue/all/networks) | | |
...
| 24 | Click the title of the first network "acronym for test network of networks" | End up at [the overview page of the network](https://data-catalogue-acc.molgeniscloud.org/testCatalogue/catalogue/all/networks/testNetworkofNetworks) | | |
| 25 | Check the breadcrumb | It should be "ALL > NETWORKS" | | |
| 26 | Click `NETWORKS` in the breadcrumb | End up at [the networks screen](https://data-catalogue-acc.molgeniscloud.org/testCatalogue/catalogue/all/networks) again | | |
...
| | | | | |
| 28 | Click on `COLLECTIONS` in the ribbon | End up at [the collections screen](https://data-catalogue-acc.molgeniscloud.org/testCatalogue/catalogue/all/collections) | | |
